...
var Biom = exports.Biom = function () {
    ...
    function Biom() {
        ...
        var _shape = _ref$shape === undefined ? null : _ref$shape;
    ...
    _createClass(Biom, [{
        ...
        value: function setDataRow(rowID, values) {
            ...
            if (this.matrix_type === 'dense') {
                ...
                try {
                    for (var _iterator5 = toRemove.sort(function (a, b) {
                        return b - a;
        ...
        value: function setDataColumn(colID, values) {
            ...
            if (this.matrix_type === 'dense') {
                ...
                try {
                    for (var _iterator8 = toRemove.sort(function (a, b) {
                        return b - a;
        ...
        value: function _indexByID(id) {
            var inRow = arguments.length <= 1 || arguments[1] === undefined ? true : arguments[1];
        ...
        value: function write() {
            ...
            var _ref4$asHdf = _ref4.asHdf5;

            var _asHdf5 = _ref4$asHdf === undefined ? false : _ref4$asHdf;
        ...
        value: function parse() {
            ...
            var _ref5$conversionServe = _ref5.conversionServer;

            var _conversionServer = _ref5$conversionServe === undefined ? null : _ref5$conversionServe;

            var _ref5$arrayBuffer = _ref5.arrayBuffer;

            var _arrayBuffer = _ref5$arrayBuffer === undefined ? null : _ref5$arrayBuffer;
