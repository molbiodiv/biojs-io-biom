    ...
    _createClass(Biom, [{
        ...
        value: function toString() {
            ...
            var convertMetadataObjectsToString = function convertMetadataObjectsToString(biom, dimension) {
                ...
                try {
                    for (var _iterator = biomCopy[dimension][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        value: function addMetadata() {
            ...
            if (_values !== null) {
                ...
                try {
                    for (var _iterator4 = dim[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
        ...
        value: function setDataRow(rowID, values) {
            ...
            if (this.matrix_type === 'dense') {
                ...
                try {
                    for (var _iterator7 = toRemove.sort(function (a, b) {
                        return b - a;
        ...
        value: function setDataColumn(colID, values) {
            ...
            if (this.matrix_type === 'dense') {
                ...
                try {
                    for (var _iterator10 = toRemove.sort(function (a, b) {
                        return b - a;
